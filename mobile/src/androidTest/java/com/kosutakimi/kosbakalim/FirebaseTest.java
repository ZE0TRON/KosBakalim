    ...
    public void useAppContext() throws Exception {
     ...
     //   System.out.println("is signed(false): " + user.isSigned());
       ...
       // System.out.println("Original user Create Method : "+ newbridge.createUserEP("batuhan12@gmail.com","123qwe"));
        ...
        newbridge.createUserEP("bilge@acmhacettepe.com","deneme123");
        newbridge.sigInEP("bilge@acmhacettepe.com","deneme123");
        System.out.println(newbridge.getCurrentUser().getEmail());

        System.out.println(newbridge.getCurrentUser().getUid());
